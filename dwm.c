...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int isfixed, iscentered, isfloating, isalwaysontop, isfreesize, isurgent, neverfocus, oldstate, isfullscreen, issticky, isterminal, noswallow;
	int issteam;
	pid_t pid;
	Client *next;
	Client *snext;
